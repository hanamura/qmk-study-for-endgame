...
[_QWERTY] = KEYMAP( \
  ...
  M_CAG,   KC_LCTL,  KC_LALT, CMD_EISU, LOWER, NUMPAD, KC_SPC, RAISE, CMD_KANA, KC_RALT, KC_RCTL, M_CAG    \
),
...
[_ADJUST] = KEYMAP( \
  _______, _______, _______, KC_PGUP, KC_VOLU, FO_MENU,   FO_TOOL,   KC_BTN1, KC_MS_U,  KC_BTN2, RGB_HUI, RGB_HUD, \
